let products = [
  {
    ...
    desc: "This project is a good learning project to get comfortable with soldering and programming an Arduino.",
  },
  {
    id: "1",
    ...
    desc: "Use craft items you have around the house, plus two LEDs and a LilyPad battery holder, to create a useful book light for reading in the dark.",
  },
  {
    id: "2",
    ...
    desc: "Create a web-connected light-strip API controllable from your website, using the Particle.io.",
  },
  {
    id: "3",
    ...
    desc: "Use an Altoids tin with Chibitronics sticker LEDs to create a light-up compact that doubles as a survival kit for the young hipster",
  },
  {
    id: "4",
    ...
    desc: "Visualization of sailor scouts sorted by bubblesort algorithm by their planet\u0027s distance from the sun",
  },
  {
    id: "5",
  ...
  },
  {
    ...
    desc: "Pastel hardware kits complete with custom manufactured pastel alligator clips.",
  },
  {
    id: "7",
  ...
  },
  {
    ...
    title: "Hipster Dev",
    desc: "Hipster Dev is busy coding away while styled in a camo jacket and orange beanie.",
  },
  {
    id: "11",
    ...
    desc: "Everyone\u2019s favorite design is finally here on a tee! The Pretty Girls Code crew-neck tee is available in a soft pink with red writing.",
  },
  {
    id: "12",
    img: "https://user-images.githubusercontent.com/41929050/61567063-14c4b300-aa33-11e9-8515-bcb866da9ea3.png",
    title: "Ruby Sis",
    desc: "Styled in a dashiki, Ruby Sis is listening to music while coding in her favorite language, Ruby!",
  },
  {
    id: "13",
    ...
    desc: "Not sure if I\u0027ll be making more, get it while I have it in the store.",
  },
  {
    id: "14",
